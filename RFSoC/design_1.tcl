...
xilinx.com:hls:mm2s_replay_engine_V2:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: adc_read, and set properties
  set adc_read [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 adc_read ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {106.319} \
   CONFIG.CLKOUT1_PHASE_ERROR {130.565} \
  ...
  # Create instance: engine_out, and set properties
  set engine_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 engine_out ]
  set_property -dict [ list \
   CONFIG.C_DATA_DEPTH {2048} \
  ...
  # Create instance: engine_out1, and set properties
  set engine_out1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 engine_out1 ]
  set_property -dict [ list \
   CONFIG.C_DATA_DEPTH {2048} \
   CONFIG.C_NUM_MONITOR_SLOTS {1} \
   CONFIG.C_SLOT {0} \
  ...
  # Create instance: mm2s_replay_engine_V2_0, and set properties
  set mm2s_replay_engine_V2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mm2s_replay_engine_V2:1.0 mm2s_replay_engine_V2_0 ]
  ...
  # Create instance: throw_tlast_0, and set properties
  set block_name throw_tlast
  set block_cell_name throw_tlast_0
  if { [catch {set throw_tlast_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $throw_tlast_0 eq "" } {
  ...
  # Create instance: tlast_controller, and set properties
  set tlast_controller [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 tlast_controller ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC_Decimation_Mode01 {5} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins ps8_0_axi_periph1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS [get_bd_intf_pins axis_combiner_1/M_AXIS] [get_bd_intf_pins throw_tlast_0/s_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins engine_out1/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net mm2s_replay_engine_0_out_stream [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins mm2s_replay_engine_V2_0/out_stream]
connect_bd_intf_net -intf_net [get_bd_intf_nets mm2s_replay_engine_0_out_stream] [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins engine_out/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net mm2s_replay_engine_V2_0_m_axi_gmem [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins mm2s_replay_engine_V2_0/m_axi_gmem]
  connect_bd_intf_net -intf_net ps8_0_axi_periph1_M00_AXI [get_bd_intf_pins ps8_0_axi_periph1/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins mm2s_replay_engine_V2_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins tlast_controller/S_AXI]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins usp_rf_data_converter_0/sysref_in]
  connect_bd_intf_net -intf_net throw_tlast_0_m_axis [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins throw_tlast_0/m_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins axis_combiner_1/S00_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets usp_rf_data_converter_0_m00_axis] [get_bd_intf_pins adc_read/SLOT_0_AXIS] [get_bd_intf_pins axis_combiner_1/S00_AXIS]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m01_axis [get_bd_intf_pins axis_combiner_1/S01_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m01_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets usp_rf_data_converter_0_m01_axis] [get_bd_intf_pins adc_read/SLOT_1_AXIS] [get_bd_intf_pins axis_combiner_1/S01_AXIS]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins throw_tlast_0/packet_count_in] [get_bd_pins tlast_controller/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins adc_read/clk] [get_bd_pins axis_combiner_1/aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins throw_tlast_0/clk] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins engine_out1/clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins adc_read/resetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_combiner_1/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins engine_out/resetn] [get_bd_pins engine_out1/resetn] [get_bd_pins mm2s_replay_engine_V2_0/ap_rst_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ps8_0_axi_periph1/ARESETN] [get_bd_pins ps8_0_axi_periph1/M00_ARESETN] [get_bd_pins ps8_0_axi_periph1/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins throw_tlast_0/reset] [get_bd_pins tlast_controller/s_axi_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_dac0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins engine_out/clk] [get_bd_pins mm2s_replay_engine_V2_0/ap_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins ps8_0_axi_periph1/ACLK] [get_bd_pins ps8_0_axi_periph1/M00_ACLK] [get_bd_pins ps8_0_axi_periph1/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins tlast_controller/s_axi_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces mm2s_replay_engine_V2_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mm2s_replay_engine_V2_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mm2s_replay_engine_V2_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tlast_controller/S_AXI/Reg] -force
